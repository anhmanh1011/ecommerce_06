    <%@ page language="java" contentType="text/html; charset=utf-8" %>
        ...
        C26.961,15.728,22.503,11.008,14.796,11.376z
        M9,23.284c0.921-2.508,3.033-4.514,6.298-4.627c3.083-0.107,4.994,1.976,5.685,4.627
        ...
        <select name='suppiler' id='product_cat' class='postform resizeselect'>
        ...
        <i class="ec ec-shopping-bag"></i>
            <span id="countProduct" class="cart-items-count count">0 </span>
        </a>
        ...
        <li class="menu-item
        animate-dropdown"><a title="TV &amp; Audio" href="product-category.html">TV &#038; Audio</a></li>
        <li class="menu-item"><a title="RTV" href="product-category.html">RTV</a></li>
        <li class="menu-item"><a title="Computers" href="product-category.html">Computers</a></li>
        <li class="menu-item"><a title="Games &amp; Consoles" href="product-category.html">Games &#038;
        Consoles</a></li>
        <li class="menu-item"><a title="Gadgets" href="product-category.html">Gadgets</a></li>
        <li class="menu-item"><a title="Phones &amp; Tablets" href="product-category.html">Phones &#038;
        Tablets</a></li>
        <li class="menu-item"><a title="GPS &amp; Car Audio" href="product-category.html">GPS &#038; Car
        Audio</a></li>
        <li class="menu-item"><a title="Accessories" href="product-category.html">Accessories</a></li>
        </ul>
        </div><!-- /.collpase -->
        </div><!-- /.-container -->
        </nav><!-- /.navbar -->